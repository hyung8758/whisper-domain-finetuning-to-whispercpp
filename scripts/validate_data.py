...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_root", dest="manifest_dir", type=Path, default=argparse.SUPPRESS, help=argparse.SUPPRESS)
    parser.add_argument("--project_root", type=Path, default=DOMAIN_ROOT)
    parser.add_argument("--max_errors", type=int, default=20)
    parser.add_argument("--show_first_row", action="store_true")
...
def main() -> None:
    ...
    LOGGER.info("Fine-tuning manifests look good: %s", args.manifest_dir)
